...
\textbf{TLDR: HMI Max temp:87.1 °C (188.78 °F)}

\end{abstract}

\section*{Method}
The Ed-HMI220-070C in this testing sequence was subjugated to 100\% CPU load for the durration of the workday 3.23.26 packed in an insulated box with 0 ventilation. \\
